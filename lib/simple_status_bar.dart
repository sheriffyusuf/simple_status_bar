...
class SimpleStatusBar {
  ...
  static const String _CHANGE_NAVIGATION_BAR_COLOR_METHOD =
      "changeNavigationBarColor";

  // change navigation bar color
  static Future changeNavBarColor() async {
    return await _channel.invokeMethod(_CHANGE_NAVIGATION_BAR_COLOR_METHOD);
  }
  ...
  static Future<bool> toggle({bool show, StatusBarAnimation animation}) async {
  ...
  static Future changeStatusBarColor(
    ...
    if (adaptiveBrightness ?? true) {
      ...
      print(
          "Computing Color Luminance :  $luminance ==================> DARK : $isDarkColor");
    }
